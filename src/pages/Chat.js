...
const Chat = () => {
  ...
  const handleReaction = (type, msg, idx) => {
    setShowEmojis(false);
  };
                  ...
                  <Collapse in={expanded}>
                    <div className="flex gap-2">
                      {groupInfo.participants.map((member, i) => (
                        <Avatar key={i} alt={member.user} src={member.avatar} />
                      ))}
                    </div>
                  </Collapse>
                </div>
                      ...
                      {msg.userId === 66 && (
                        <div>
                          {hoveredMsgIdx === i ? (
                            <IconButton
                              ref={emojiButtonRef}
                              onClick={() => handleEmotionChoose(i)}
                            >
                              <MoodIcon />
                            </IconButton>
                          ) : (
                            moment(msg.timestamp).format("YYYY/MM/DD A hh:mm")
                          )}
                        </div>
                      )}
                      <div
                    ...
                    {showEmojis && (
                      ...
                      >
                        <div className="flex">
                          <IconButton
                            onClick={() =>
                              handleReaction("like", msg, i)
                            }
                          >
                            <Emojione text=":thumbsup:" className="text-3xl" />
                          </IconButton>
                          <IconButton
                            onClick={() =>
                              handleReaction("love", msg, i)
                            }
                          >
                            <Emojione text=":heart:" className="text-3xl" />
                          </IconButton>
                          <IconButton
                            onClick={() =>
                              handleReaction("laugh", msg, i)
                            }
                          >
                            <Emojione text=":laughing:" className="text-3xl" />
                          </IconButton>
                        </div>
                      </div>
                    )}
